...
def mouse_callback(event, x, y, flags, param): #substituir por função do laser
...
def panel_creation():
    ...
    cv2.setMouseCallback("Panel", mouse_callback) # Substituir pelo deslocamento do laser
